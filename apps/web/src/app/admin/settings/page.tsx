  ...
  return (
    <div>
      ...
      <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-12 text-center">
        ...
        <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Configurações da federação</p>
        <p className="text-xs text-zinc-400">Nome, logo, domínio e preferências serão configuráveis na Phase 2.</p>
      </div>
    </div>
  );
}
